...
<div class="signup-form">
    <form action="servSignUp" method="post">
		<h2>Sign Up</h2>
        ...
        <div class="form-group">
			<div class="input-group">
				...
				<input type="text" class="form-control" name="txtTenDangNhap" placeholder="Username" required="required">
			</div>
        </div>
        <div class="form-group">
			<div class="input-group">
		...
		<div class="form-group">
			<div class="input-group">
				...
				<input type="password" class="form-control" name="txtConfirm"placeholder="Confirm password" required="required">
			</div>
        </div>
        <div class="form-group">
